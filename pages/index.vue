...
import IconVector from "@/assets/icons/IconVector.vue";
...
const categories = [
  {
    ...
    title: "Communication",
    description:
      "Démystifiez le jargon technique et communiquez-le clairement, facilitant ainsi les échanges.",
  },
  {
    icon: IconHeart,
    title: "Émotion",
  ...
  <section class="mx-auto font-regular tracking-tighter">
    ...
    >
      <div class="w-full md:max-w-[50%] relative z-10">
        ...
        >
          <span
            class="bg-green-dark w-[65vw] md:w-[360px] lg:w-[440px] h-[10vw] md:h-[3.5rem] lg:h-20 absolute top-[12vw] md:top-[3.5rem] lg:top-[4.6rem] right-[9vw] md:right-[2.5rem] lg:right-[6.2rem] -z-10 rounded-lg"
          />
          Teste tes acquis <br />de
          <span
            class="text-background text-[10vw] md:text-[3.4rem] lg:text-[4rem]"
            >développeur·se</span
          >
          avant de postuler
        </h1>
